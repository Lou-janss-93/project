...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    landing: {
      ...
      step1Description: 'Select how you want to present yourself: Real Me, My Mask, or Crazy Self.',
  ...
  nl: {
    ...
    landing: {
      ...
      step1Description: 'Selecteer hoe je jezelf wilt presenteren: Real Me, My Mask, of Crazy Self.',
